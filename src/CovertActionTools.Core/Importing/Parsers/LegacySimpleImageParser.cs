...
namespace CovertActionTools.Core.Importing.Parsers
{
    internal class LegacySimpleImageParser : BaseImporter<Dictionary<string, SimpleImageModel>>, ILegacyParser
    {
        ...
        private readonly ILegacySpriteSheetContainer _spriteSheetContainer;
        ...
        public LegacySimpleImageParser(ILogger<LegacySimpleImageParser> logger, SharedImageParser imageParser, ILegacySpriteSheetContainer spriteSheetContainer)
        {
            _logger = logger;
            _imageParser = imageParser;
            _spriteSheetContainer = spriteSheetContainer;
        }
        ...
        private SimpleImageModel Parse(string path, string key)
        {
            ...
            if (_spriteSheetContainer.TryGet(key, out var defaultSpriteSheet))
            {
